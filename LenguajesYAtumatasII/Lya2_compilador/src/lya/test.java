...
public class test implements testConstants {
	...
	public static void main(String[] args)throws ParseException{
		try{
			...
			analizador.Programa();
			//AnalisisSemantico as= new AnalisisSemantico(analizador.jj_input_stream.GetImage());
			if(error.equals(""))
...
static final public String variable_type() throws ParseException {
  ...
  static private boolean jj_3R_3() {
    if (jj_scan_token(while_declaration)) return true;
  ...
  static private boolean jj_3R_2() {
    if (jj_scan_token(if_declaration)) return true;
    if (jj_scan_token(open_parenthesis)) return true;
    return false;
  }
  ...
  static private boolean jj_3R_4() {
    if (jj_scan_token(type_specifier)) return true;
    return false;
  }
